                ...
                <div class="relative flex flex-col col-span-12 gap-y-7 lg:col-span-12 xl:col-span-12">
                            ...
                            <div class="mt-5">
                                ...
                                <div
                                    ...
                                    <div class="inline-block mb-2 sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 xl:w-60">
                                        <div class="text-left">
                                            ...
                                            <div class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                Ingrese el nombre del comprobante
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex-1 w-full mt-3 xl:mt-0">
                                        <x-base.form-input
                                            class="mb-2"
                                            type="text"
                                            placeholder="Ingrese el nombre del comprobante"
                                            wire:model="name"
                                        />
                                        @error('name')
                                        <div class="p-1">
                                ...
                                <div
                                    ...
                                    <div class="flex-1 w-full mt-3 xl:mt-0">
                                        <x-base.form-input
                                            class="mb-2"
                                            type="text"
                                            placeholder="Ingrese el número de serie del comprobante"
                                            wire:model="serie"
                                        />
                                        @error('serie')
                                        <div class="p-1">
                                ...
                                <div
                                    ...
                                    <div class="inline-block mb-2 sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 xl:w-60">
                                        <div class="text-left">
                                            <div class="flex items-center">
                                                <div class="font-medium">Número</div>
                                                <div
                                                    class="ml-2.5 rounded-md border border-slate-200 bg-slate-100 px-2 py-0.5 text-xs text-slate-500 dark:bg-darkmode-300 dark:text-slate-400">
                                                    Required
                                                </div>
                                    ...
                                    <div class="flex-1 w-full mt-3 xl:mt-0">
                                        <x-base.form-input
                                            class="mb-2"
                                            type="text"
                                            placeholder="Ingrese número del comprobante"
                                            wire:model="number"
                                        />
                                        @error('number')
                                        <div class="p-1">
                    ...
                    <div class="flex flex-col justify-end gap-3 mt-1 md:flex-row">
                        <x-base.button
                            ...
                            onclick="window.location.href='{{ route('vouchers.index') }}'"
                        >
                            <div class="px-2">
