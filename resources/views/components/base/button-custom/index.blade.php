@props(['as' => 'button', 'variant' => null, 'elevated' => null, 'size' => 'sm', 'rounded' => null])

@php
    // General Styles
    $generalStyles = [
        'transition duration-200 border shadow-sm inline-flex items-center justify-center rounded-md font-medium cursor-pointer text-xs py-1.5 px-2', // Default
